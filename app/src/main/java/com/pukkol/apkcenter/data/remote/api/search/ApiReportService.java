...
public interface ApiReportService {
    ...
    Call<StatusModel> reportRemove(@Query(value = "title", encoded = true) String title, @Query(value = "icon", encoded = true) String icon, @Query(value = "url", encoded = true) String url);
}
